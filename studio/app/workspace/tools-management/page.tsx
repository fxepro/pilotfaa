...
const TOOLS: Tool[] = [
  ...
  },
  {
    id: "ai-models",
    name: "AI Models",
    service: "Platform AI Integration",
    type: "custom",
    apiKeyName: "",
    status: "configured",
    description: "Manage and configure AI models for platform features",
    icon: Cpu,
  },
  {
    id: "databases",
    ...
    apiKeyName: "",
    status: "configured",
    description: "Configure and manage database connections and schemas",
    icon: Database,
  },
];
