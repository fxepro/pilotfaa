  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <SimpleHeroSection
        ...
        subtitle="Get access to a demo account with pre-loaded sample data to explore all features and capabilities of the Admin Rodeo platform foundation."
              />
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        {/* Demo Request Form */}
        <Card id="demo-form" className="shadow-lg">
          <CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="What do you want to use Admin Rodeo for?" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="SaaS Platform Development">SaaS Platform Development</SelectItem>
                    <SelectItem value="E-commerce Application">E-commerce Application</SelectItem>
                    ...
                    <SelectItem value="Enterprise Application">Enterprise Application</SelectItem>
                    <SelectItem value="Multi-tenant Platform">Multi-tenant Platform</SelectItem>
                    <SelectItem value="Custom Admin Panel">Custom Admin Panel</SelectItem>
                    <SelectItem value="Other">Other</SelectItem>
                  </SelectContent>
                </Select>
              </div>
