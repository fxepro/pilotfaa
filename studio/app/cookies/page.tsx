    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          How Admin Rodeo uses cookies and similar technologies to enhance your experience
        </p>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  We may use third-party monitoring services that set cookies to help us track platform performance and identify issues.
                </p>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-muted-foreground">Email: privacy@rodeoadmin.com</p>
