  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <SimpleHeroSection
        ...
        subtitle="Help us improve Admin Rodeo by sharing your thoughts, suggestions, and experiences"
      />
        ...
        <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
          <CardHeader className="text-center pb-8 pt-12">
            ...
            <CardDescription className="text-lg text-gray-600">
              Your feedback helps us make Admin Rodeo better for everyone
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    placeholder="Tell us what you loved about Admin Rodeo. What features worked well? What exceeded your expectations?"
                    value={greatWork}
