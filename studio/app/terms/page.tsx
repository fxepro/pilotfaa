    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          The terms and conditions governing your use of Admin Rodeo services
        </p>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              By accessing and using Admin Rodeo ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>
            <p className="text-muted-foreground">
              These Terms of Service ("Terms") govern your use of our platform services. Please read these Terms carefully before using our Service.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>What Admin Rodeo provides</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              Admin Rodeo provides platform services, including:
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              When using Admin Rodeo, you agree to:
            </p>
            <ul className="space-y-2 text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                The Service and its original content, features, and functionality are owned by Admin Rodeo and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
              </p>
            </div>
            <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              To the maximum extent permitted by law, Admin Rodeo shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
            </p>
            <ul className="space-y-2 text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-muted-foreground">Email: legal@rodeoadmin.com</p>
              <p className="text-muted-foreground">Website: rodeoadmin.com</p>
            </div>
          </CardContent>
        </Card>
      </div>
