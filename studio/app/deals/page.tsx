    ...
    <div className="min-h-screen bg-gradient-to-br from-palette-accent-3 via-white to-palette-accent-3">
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        ...
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-palette-primary text-white px-4 py-2">
            <Tag className="h-4 w-4 mr-2" />
            LIMITED TIME OFFERS
          </Badge>
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-palette-primary to-palette-secondary bg-clip-text text-transparent">
            Special Deals & Promotions
          </h1>
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Take advantage of our limited-time offers and save on your subscription
          </p>
        </div>
