...
export default function AdminSidebar({ currentPath }: AdminSidebarProps) {
  // Admin Panel items (core admin functions) - DEPRECATED: Use /workspace/* instead
  ...
  // Platform Panel items (platform integrations and financials) - DEPRECATED: Use /workspace/* instead
