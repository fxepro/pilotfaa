...
// Page configuration mapping - DEPRECATED: /admin/* routes moved to /workspace/*
const pageConfig: Record<string, {
  ...
  "/workspace/seo-monitoring": {
    title: "SEO Monitoring",
    description: "Track SEO rankings and keywords",
    icon: Search
  },
  ...
  // DEPRECATED: Legacy /admin/* routes (kept for backward compatibility)
  "/admin/dashboard": {
    title: "Overview",
    description: "Admin dashboard overview and key metrics",
    icon: BarChart3
