# Generated by Django 5.2.6 on 2025-12-17 20:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_links', models.JSONField(blank=True, default=dict, help_text='Social media links (Twitter, LinkedIn, etc.)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('translations', models.JSONField(blank=True, default=dict, help_text='Translations of this post')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['slug'], name='blog_blogpo_slug_361555_idx'), models.Index(fields=['status'], name='blog_blogpo_status_9c1956_idx'), models.Index(fields=['published_at'], name='blog_blogpo_publish_9c2556_idx'), models.Index(fields=['featured'], name='blog_blogpo_feature_0ec342_idx'), models.Index(fields=['language'], name='blog_blogpo_languag_7091bf_idx')],
            },
        ),
    ]
