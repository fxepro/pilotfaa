...
ALLOWED_HOSTS = get_env_list('ALLOWED_HOSTS', default=['adminrodeo.com',
    'www.adminrodeo.com','3.151.149.58','localhost', '127.0.0.1'])

# Frontend URL - used for email verification links and other frontend redirects
# Set via environment variable: FRONTEND_URL=https://adminrodeo.com
...
# Set via environment variable as comma-separated list: http://129.146.57.158,https://adminrodeo.com,http://adminrodeo.com
...
INSTALLED_APPS = [
    ...
    # 'performance_analysis',  # Deprecated
    # 'monitor_analysis',  # Deprecated
    # 'dns_analysis',  # Deprecated
    # 'sitemap_analysis',  # Deprecated
    # 'typography_analysis',  # Deprecated
    # 'ssl_analysis',  # Deprecated
...
MIDDLEWARE = [
    ...
    # DISABLED - logging stopped per user request
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'connect_timeout': 10,
            # Enforce app-owned schemas (core first, public last)
            'options': (
                '-c search_path='
...
# Leading slash required: admin lives at /django-admin/; a relative "static/" would resolve to
# /django-admin/static/... and CSS/JS would 404.
STATIC_URL = '/static/'
...
try:
    ...
    # HTTPS Enforcement
    # DEBUG is controlled by the DEBUG env var (see above). Do not force False here — that breaks
    # django-admin styling on runserver (staticfiles are not served the same way when DEBUG=False).
    # Disable SECURE_SSL_REDIRECT since Apache handles SSL termination
